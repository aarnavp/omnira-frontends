 ...
 * path, an SVG-native <animateMotion> dot travelling along it — the
 * "packet moving through the system" visual from PROMPT §6, built on the
 * network's own geometry rather than a decorative overlay. */
