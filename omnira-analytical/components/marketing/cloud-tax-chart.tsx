...
/** The "Cloud Tax" comparison for §05 Economics: continuously provisioned
...
export function CloudTaxChart() {
  ...
  if (isLoading) {
    return (
      <div className="flex h-[340px] flex-col gap-3 rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface-raised) p-5">
