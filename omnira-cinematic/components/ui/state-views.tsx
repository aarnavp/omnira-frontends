 ...
 * Errors say what broke and the next move; empty states invite action, not
 * apologize.
 */
...
export function ErrorState({
  ...
  return (
    <div
      role="alert"
      className="flex flex-col items-start gap-3 rounded-(--radius-lg) border border-(--color-hairline) bg-(--color-panel) p-8"
    >
