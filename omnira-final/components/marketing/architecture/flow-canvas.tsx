...
/** The one signature animated centerpiece (§04 Architecture) — a
 * scroll-triggered entrance wraps this in `<Reveal>` from the calling
 * section; internally it's the same interactive Data/Control/Compute/Cloud
 * diagram as omnira-analytical, restyled dark. */
export function FlowCanvas({
  ...
  return (
    <div className="h-[380px] rounded-(--radius-lg) border border-(--color-hairline) bg-(--color-panel-sunken)">
      <ReactFlow
        nodes={nodes}
        edges={edges}
        nodeTypes={nodeTypes}
