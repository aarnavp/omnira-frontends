 ...
 * earnings pitch (root AGENTS §1) — this is a working control, not a
 * promise. */
export function ContributeControlDemo() {
  const [contributing, setContributing] = useState(true);

  return (
    <div className="flex items-center justify-between gap-4 rounded-(--radius-lg) border border-(--color-hairline) bg-(--color-ground) p-4">
      <div>
